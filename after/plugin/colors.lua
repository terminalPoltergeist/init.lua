...
vim.api.nvim_set_hl(0, 'PMenu', { fg = colors.gui05, bg = 'none' })
vim.api.nvim_set_hl(0, 'PMenuSel', { fg = colors.gui05, bg = colors.gui01 })
vim.api.nvim_set_hl(0, 'NormalFloat', { bg = 'none' })
vim.api.nvim_set_hl(0, 'FloatBorder', { fg = colors.gui0A, bg = 'none' })
...
vim.api.nvim_set_hl(0, 'Label', { fg = colors.gui0A, bg = colors.gui02 })
