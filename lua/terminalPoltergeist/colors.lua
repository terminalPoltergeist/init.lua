...
vim.api.nvim_set_hl(0, 'Comment', { fg = gui05 })
...
vim.api.nvim_set_hl(0, 'gitcommitBranch', { fg = gui09, bold = true })
vim.api.nvim_set_hl(0, 'gitcommitUntrackedFile', { fg = gui0A })
vim.api.nvim_set_hl(0, 'gitcommitUnmergedFile', { fg = gui08, bold = true })
vim.api.nvim_set_hl(0, 'gitcommitDiscardedFile', { fg = gui08, bold = true })
vim.api.nvim_set_hl(0, 'gitcommitSelectedFile', { fg = gui0B, bold = true })

-- GitGutter highlighting
vim.api.nvim_set_hl(0, 'GitGutterAdd', { fg = gui0B, bg = gui01 })
vim.api.nvim_set_hl(0, 'GitGutterChange', { fg = gui0D, bg = gui01 })
vim.api.nvim_set_hl(0, 'GitGutterDelete', { fg = gui08, bg = gui01 })
vim.api.nvim_set_hl(0, 'GitGutterChangeDelete', { fg = gui0E, bg = gui01 })
...
vim.api.nvim_set_hl(0, 'DiagnosticOk', { fg = gui0B })
vim.api.nvim_set_hl(0, 'DiagnosticHint', { fg = gui0C })
vim.api.nvim_set_hl(0, 'DiagnosticInfo', { fg = gui0D })
vim.api.nvim_set_hl(0, 'DiagnosticWarn', { fg = gui09 })
vim.api.nvim_set_hl(0, 'DiagnosticError', { fg = gui08 })
