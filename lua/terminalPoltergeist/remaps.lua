...
-- netrw
key.set("n", "<leader>fs", vim.cmd.Ex)
...
-- quickfix motions
key.set("n", "<M-j>", ":cnext<CR>", { silent = true })
key.set("n", "<M-k>", ":cprevious<CR>", { silent = true })
key.set("n", "<M-c>", ":cclose<CR>", { silent = true })
key.set("n", "<M-o>", ":copen<CR>", { silent = true })
